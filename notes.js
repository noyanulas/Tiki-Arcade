...
(function(){
  const NOTES = [
    ...
    "Hatırlatma, gremlin gibi oturma.",
    "Seni görünce sizi yicem hanımefendi.",
    "Bugün derse gittiğin için seni kutluyorum.",
    "En sıradan günleri bile hatırlanmaya değer kılıyorsun.",
    "Oley bu kadar ödül açmışsın seni tebrik ediyorum.",
    "Naber şirin şey ❤️",
